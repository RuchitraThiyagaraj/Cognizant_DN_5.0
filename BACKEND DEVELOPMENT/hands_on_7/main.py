...
@app.post("/api/courses", response_model=CourseResponse , tags=["Courses"],    summary="Create a new course",
    response_description="The created course with generated ID" ,  status_code=201)
...
@app.get("/api/courses/{course_id}", tags=["Courses"],  response_model=CourseResponse)
...
@app.get("/api/courses", tags=["Courses"],  response_model=list[CourseResponse])
...
@app.patch("/api/courses/{course_id}", tags=["Courses"],  response_model=CourseResponse)
...
@app.delete("/api/courses/{course_id}" , tags=["Courses"], status_code=204)
...
#create new stufent
@app.post("/api/students", response_model=StudentResponse, tags=["Students"],  status_code=201)
...
@app.get("/api/students/{student_id}",tags=["Students"], response_model=StudentResponse)
...
#get all students
@app.get("/api/students",tags=["Students"], response_model=list[StudentResponse])
...
@app.patch("/api/students/{student_id}",tags=["Students"], response_model=StudentResponse)
...
#Get all enrollments
@app.get("/api/enrollments",tags=["Enrollments"], response_model=list[EnrollmentOut])
...
@app.get("/api/enrollments/{enrollment_id}", tags=["Enrollments"],response_model=EnrollmentOut)
...
@app.delete("/api/enrollments/{enrollment_id}",tags=["Enrollments"], status_code=status.HTTP_204_NO_CONTENT)
...
#add enrollments
@app.post("/api/enrollments", response_model=EnrollmentOut,tags=["Enrollments"], status_code=201)
...
#update enrollment
@app.patch("/api/enrollments/{enrollment_id}",tags=["Enrollments"], response_model=EnrollmentOut)
...
@app.get("/api/courses/{course_id}/students",tags=["Enrollments"], response_model=list[StudentResponse])
